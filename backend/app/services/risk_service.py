...
class RiskService:
    def __init__(self):
        logger.warning("WARNING: RiskService is using a synthetic Random Forest model trained on 9 samples. This is for demonstration purposes only. A real model trained on historical data must be used in production.")
    ...
    def calculate_risk(self, ela_score: float, layout_entities_count: int, metadata_anomaly: float = 0.0, cmfd_score: float = 0.0, tampered_fields: list = None, layoutlm_forgery_prob: float = 0.0, vit_forgery_prob: float = 0.0) -> dict:
        ...
        try:
            ...
            return {
                ...
                "limitation_warning": "WARNING: Risk score is generated by a synthetic model trained on limited sample data."
            }
